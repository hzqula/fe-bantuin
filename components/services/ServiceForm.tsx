...
const ServiceForm = ({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      {/* max-w-2xl: Lebar modal agar pas untuk form.
        max-h-[85vh]: Tinggi maksimal 85% layar viewport.
        overflow-y-auto: Scroll hanya pada konten modal jika terlalu panjang.
      */}
      <DialogContent className="max-w-3xl max-h-[85vh] overflow-y-auto sm:p-6">
        <DialogHeader>
          <DialogTitle>
        ...
        {/* Form Area 
          Padding vertical ditambahkan agar tidak terlalu rapat
        */}
        <div className="py-4">
